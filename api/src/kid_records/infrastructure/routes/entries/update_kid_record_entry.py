...
class Update_kid_record_entry(BaseModel):
        ...
        kid_personal_id: Optional[str] = Field(min_length=8, default='NO SE TIENE INFO')
        kid_birth_certificate: Optional[str] = Field(min_length=5,default='NO SE TIENE INFO')
